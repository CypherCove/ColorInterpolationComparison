 ...
 * @since 0.9.3
 */
public class BasicColorPicker2 extends VisTable implements Disposable {
	...
	public BasicColorPicker2() {
		this(null);
	}

	public BasicColorPicker2(ColorPickerListener listener) {
		this("default", listener);
	}

	public BasicColorPicker2(String styleName, ColorPickerListener listener) {
		this(VisUI.getSkin().get(styleName, ColorPickerWidgetStyle.class), listener, false);
	}

	public BasicColorPicker2(ColorPickerWidgetStyle style, ColorPickerListener listener) {
		this(style, listener, false);
	}

	protected BasicColorPicker2(ColorPickerWidgetStyle style, ColorPickerListener listener, boolean loadExtendedShaders) {
